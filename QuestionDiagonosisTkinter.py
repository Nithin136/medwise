...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="MEDWISE:YOUR HEALTHMATE", bg="Red2", width="400", height="2", font=("HP Simplified", 13))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="LOGIN", height="5", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="REGISTER", height="5", width="400", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="DEVELOPED BY:", bg="Lightblue", width = "450", height = "3", font=("HP Simplified", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="ETIKALA HARINI", bg="Green", width = "450", height = "3", font=("HP Simplified", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="NITHIN REDDY", bg="Green", width = "450", height = "3", font=("HP Simplified ", 13))
        self.lblTeam2.pack()
...
class SignUp(Frame):
    ...
    def register_user(self):
        ...
        self.lblSucess=Label(root, text="Registration Success", fg="green", font=("Verdana", 11))
        self.lblSucess.pack()
